...
import { LightbulbIcon, PencilIcon, DocumentIcon, CalendarIcon } from './components/Icons';
...
- **4-marker:** "For a 4-marker, examiners want AO1 (knowledge) and AO2 (application to the case)."
- **6-marker:** "For a 6-marker, you need AO2 (application) and AO3 (analysis/chains of reasoning)."
- **9-marker:** "For a 9-marker, it's about AO2 (application/analysis) and a big focus on AO3 (evaluation/judgement)."
- **12-marker:** "For a 12-marker, you need to show all three: AO1 (knowledge), AO2 (application/analysis), and AO3 (evaluation/judgement)."
...
<marker-heading>Point 1 (Option 1)</marker-heading>
...
<marker-heading>Point 2 (Option 2)</marker-heading>
- One advantage is that [write a clear advantage].
- This means that [explain what this would do for the business].
- Because [link to the case study].
- This leads to [analyse the consequence].
...
- This leads to [analyse the consequence].
- Therefore [final impact on the business].
- However, [state a limitation or risk].
- This means that [briefly explain why this could be a problem].
...
export interface MainMenuOption {
  ...
  // For simple buttons or as a default action for expandable items
  prompt: string;
  isPro: boolean;
  action: 'chat';
  // Optional sub-options for sidebar
  subOptions?: SubMenuOption[];
}

export const MAIN_MENU_OPTIONS: MainMenuOption[] = [
    { 
        label: "Mini-lessons", 
        prompt: "I'd like a mini-lesson.", 
        isPro: false, 
        action: 'chat', 
        icon: LightbulbIcon 
        // This one has special handling in sidebar for AQA_TOPICS, not subOptions
    },
    { 
        label: "Long Answer Q's", 
        prompt: "I'd like to practice a long answer question.",
        isPro: false,
        action: 'chat',
        icon: PencilIcon,
        subOptions: [
            { label: "Learn how to do a 4-marker", prompt: "Can you teach me how to structure a 4-marker answer?", isPro: false, action: 'chat' },
            { label: "Practice a 4-marker", prompt: "I'd like to practice a 4-marker question.", isPro: false, action: 'chat' },
            { label: "Learn how to do a 6-marker", prompt: "Can you teach me how to structure a 6-marker answer?", isPro: false, action: 'chat' },
            { label: "Practice a 6-marker", prompt: "I'd like to practice a 6-marker question.", isPro: false, action: 'chat' },
            { label: "Learn how to do a 9-marker", prompt: "Can you teach me how to structure a 9-marker answer?", isPro: false, action: 'chat' },
            { label: "Practice a 9-marker", prompt: "I'd like to practice a 9-marker question.", isPro: false, action: 'chat' },
            { label: "Learn how to do a 12-marker", prompt: "Can you teach me how to structure a 12-marker answer?", isPro: false, action: 'chat' },
            { label: "Practice a 12-marker", prompt: "I'd like to practice a 12-marker question.", isPro: false, action: 'chat' }
        ]
    },
    { 
        ...
        icon: DocumentIcon,
        subOptions: [
            { label: "Make study plan", prompt: "", isPro: true, action: 'chat' },
            { label: "Start revising now", prompt: "I need to start revising for a test. Please ask me what topics are on it. Once I tell you, please provide a brief overview of those topics and then say 'Let's begin with [the first topic]' to start the first lesson.", isPro: false, action: 'chat' },
            { label: "Flash cards", prompt: "", isPro: false, action: 'chat' }
        ]
    },
    { 
        label: "My Study Timetable", 
        prompt: "Show me my study timetable.",
        isPro: false, 
        action: 'chat', 
        icon: CalendarIcon 
    },
    { 
        label: "Home-work helper", 
        prompt: "I need help with my homework. Can you ask me what I'm working on?",
        isPro: false, 
        action: 'chat', 
        icon: DocumentIcon
    },
...
export const AQA_TOPICS = [
  {
    heading: "1. Business in the Real World",
    subtopics: [
  ...
  {
    heading: "2. Influences on Business",
    subtopics: [
      "2.1 Technology",
  ...
  },
  {
    ...
    subtopics: [
      ...
      "5.2 Market Research",
      "5.3 The Marketing Mix (4Ps)",
      "5.4 Product Life Cycle and Portfolio",
      "5.5 E-commerce and Digital Marketing",
    ],
  },
  {
    heading: "6. Finance",
